...
namespace Game1
{
    ...
    {
        //instance variables (creates an instance or in simpilar terms just one of that thing, like instance of an almond)
        //reasons to create instance variables is so you can use them later for constructors, so keyboardstate as an example you can create two instance variables and have it
        //where you can have the oldKeyboardState and newState, then define the constructor below as: newState = new KeyboardState(createNewObject)
        ...
        public Game1()
        {
            ...
            //graphics is set as an instance variable above
            //this is a constructor Game1 that is setting graphics to create a new object (graphicsDeviceManger) which passing in 'this', 'this' being your Game1
        ...
        {
            //GraphicsDevice is a class that is using the method clear, clear clears resource buffers
            ...
            //spriteBatch class uses the method draw to draw the background picture
